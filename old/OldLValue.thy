...
lemma leq_card_trans[trans]: assumes "leq_card A B" and "leq_card B C" shows "leq_card A C"
  ...
  from rg_f1 rg_f2 have "(f2 o f1) ` A \<subseteq> C"
    by fastforce
  ultimately show "\<exists>f. inj_on f A \<and> f ` A \<subseteq> C" sorry
qed
...
definition lvalue_basic_cofun_squash :: "('a, 'b) lvalue_basic \<Rightarrow> ('a OldLValue.index \<Rightarrow> 'a factor) \<Rightarrow> 'a"  where
